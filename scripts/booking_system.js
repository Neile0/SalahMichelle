...
function confirmAppointmentDetails(){
    ...
    var details = `Appointment booking for  ${selectedService.type.toUpperCase() + "  " + selectedService.title.toUpperCase()}  with  ${selectedStylist.firstName.toUpperCase()}  on  ${selectedDate}  at ${convertAMPM(selectedStart)}` 
